            ...
            <div class="home__img">
                <svg class="home__blob" viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <g mask="url(#mask0)">
                        ...
                        <image class="home__blob-img" x='20' y='15' width="170px" height="170px" href="img/profil.png"/>
                    </g>
                </svg>
            </div>
    ...
    <div class="contact__container container grid">
        ...
        <form method="post" action="index.php?action=contact" id="contact__form" class="contact__form grid" name="contact__form">
            ...
            <div class="contact__content">
                ...
                <textarea name="message" id="contact__form-message" cols="1" rows="7" class="contact__input" minlength="150" maxlength="2000" required></textarea>
                <small></small>
            </div>
