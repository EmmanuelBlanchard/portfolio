        ...
        <div class="modal" id="modal" role="dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-dismiss="dialog" aria-label="Fermer" title="Fermer cette fenêtre modale"></button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="dialog" aria-label="Fermer" title="Fermer cette fenêtre modale">Fermer</button>
                </div>
            </div>
        </div>
